...
namespace IntegrationTests.Security.Controller
{
                                                  ...
                                                  IDefaultLogicTestsDeleteReadOnly
    {
        ...
        public async Task Default_GetAuditLogById_Should_Return_Unauthorized()
        {
            ...
            // Act
            var getAuditLogByIdResult = await ControllerTestUtilities.GetAllRecords(_client, _defaultRoleApiEndPoint + "/1/AuditLogs", invalidToken);
        ...
        public async Task Default_GetAuditLogById_Should_Return_Forbidden()
        {
            ...
            // Act
            var getAuditLogByIdResult = await ControllerTestUtilities.GetAllRecords(_client, _defaultRoleApiEndPoint + "/1/AuditLogs", token);
        ...
        public async Task Default_GetAuditLogById_Should_Return_NotFound()
        {
            ...
            // Act
            var result = await ControllerTestUtilities.GetAuditLogRecordsByIdWithValidationResult<RoleDto>(new HttpGetRequestParms { 
                Client = _client, 
                ApiEndPoint = _defaultRoleApiEndPoint,
                RecordId = id,
                Token = token,
