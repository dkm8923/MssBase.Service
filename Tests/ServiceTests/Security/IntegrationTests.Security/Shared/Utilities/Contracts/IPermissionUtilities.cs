...
public interface IPermissionUtilities
{
    ...
    public Task<List<PermissionDto>> CreateActiveReadOnlyTestRecords(int applicationId, short numberOfRecordsToCreate = 5);
    public Task<List<PermissionDto>> CreateInactiveReadOnlyTestRecords(int applicationId, short numberOfRecordsToCreate = 5);
