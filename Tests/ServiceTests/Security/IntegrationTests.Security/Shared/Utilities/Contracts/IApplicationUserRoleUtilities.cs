...
public interface IApplicationUserRoleUtilities
{
    ...
    public Task<ApplicationUserRoleDto> CreateActiveReadOnlyTestRecord(int applicationId, int applicationUserId, int roleId);
    public Task<ApplicationUserRoleDto> CreateInactiveReadOnlyTestRecord(int applicationId, int applicationUserId, int roleId);
