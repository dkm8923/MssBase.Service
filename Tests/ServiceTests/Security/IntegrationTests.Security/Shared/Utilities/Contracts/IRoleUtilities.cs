...
public interface IRoleUtilities
{
    ...
    public Task<List<RoleDto>> CreateActiveReadOnlyTestRecords(int applicationId, short numberOfRecordsToCreate = 5);
    public Task<List<RoleDto>> CreateInactiveReadOnlyTestRecords(int applicationId, short numberOfRecordsToCreate = 5);
