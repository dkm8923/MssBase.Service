...
{
    public Task<ErrorValidationResult<IEnumerable<RoleDto>>> GetAll(BaseServiceGet req, bool includeRelated = false);
    public Task<ErrorValidationResult<RoleDto>> GetById(int roleId, BaseServiceGet req, bool includeRelated = false);
