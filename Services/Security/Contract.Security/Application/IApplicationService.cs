...
{
    public Task<ErrorValidationResult<IEnumerable<ApplicationDto>>> GetAll(BaseServiceGet req, bool includeRelated = false);
    public Task<ErrorValidationResult<ApplicationDto>> GetById(int applicationId, BaseServiceGet req, bool includeRelated = false);
