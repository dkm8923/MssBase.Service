...
namespace Data.Security.Migrations
{
    ...
    [Migration("20260603022901_LogChangePasswordMigration")]
    partial class LogChangePasswordMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Security.Models.ApplicationUserLogChangePassword", b =>
                {
                    b.Property<int>("ApplicationUserLogChangePasswordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ApplicationUserLogChangePasswordId"));
                    ...
                    b.HasKey("ApplicationUserLogChangePasswordId");

                    b.HasIndex("ApplicationId");

                    b.HasIndex("ApplicationUserId", "ApplicationId", "OldPassword")
                        .IsUnique()
                        .HasDatabaseName("UQ_ApplicationUserLogChangePassword_ApplicationUserId_ApplicationId_OldPassword");

                    b.ToTable("ApplicationUserLogChangePassword", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Security.Models.ApplicationUserLogChangePassword", b =>
                {
                    b.HasOne("Data.Security.Models.Application", "Application")
                        ...
                        .HasForeignKey("ApplicationId")
                        .IsRequired()
                        .HasConstraintName("FK_ApplicationUserLogChangePassword_Application");

                    b.HasOne("Data.Security.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .IsRequired()
                        .HasConstraintName("FK_ApplicationUserLogChangePassword_User");
