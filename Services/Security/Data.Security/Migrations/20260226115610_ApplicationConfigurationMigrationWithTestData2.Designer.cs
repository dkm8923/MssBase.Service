...
namespace Data.Security.Migrations
{
    ...
    [Migration("20260226115610_ApplicationConfigurationMigrationWithTestData2")]
    partial class ApplicationConfigurationMigrationWithTestData2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Security.Models.Application", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreatedBy = "dmaukTest",
                            CreatedOn = new DateTime(2026, 2, 26, 11, 56, 9, 505, DateTimeKind.Utc).AddTicks(1889),
                            Description = "Description1",
                            Name = "Application1",
                            UpdatedBy = "dmaukTest",
                            UpdatedOn = new DateTime(2026, 2, 26, 11, 56, 9, 505, DateTimeKind.Utc).AddTicks(2539)
                        },
                        new
                        {
                            ApplicationId = 2,
                            Active = true,
                            CreatedBy = "dmaukTest",
                            CreatedOn = new DateTime(2026, 2, 26, 11, 56, 9, 505, DateTimeKind.Utc).AddTicks(3541),
                            Description = "Description2",
                            Name = "Application2",
                            UpdatedBy = "dmaukTest",
                            UpdatedOn = new DateTime(2026, 2, 26, 11, 56, 9, 505, DateTimeKind.Utc).AddTicks(3542)
                        });
                });
